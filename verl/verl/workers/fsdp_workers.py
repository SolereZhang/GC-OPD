...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
            ...
            if has_remote_code:
                ...
                match auto_class:
                    ...
                    case "AutoModelForImageTextToText":
                        actor_module_class = AutoModelForImageTextToText or AutoModelForVision2Seq
                    case _:
    ...
    def compute_ref_log_prob(self, data: DataProto):
        # FiRe-OPD requires teacher entropy even when selected by method name.
        compute_teacher_entropy = False
        if hasattr(self.config, "actor"):
            ...
            compute_teacher_entropy = bool(
                getattr(policy_loss, "entropy_aware_distill", False)
                or resolve_policy_loss_method(policy_loss) == "fire"
            )
