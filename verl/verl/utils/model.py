...
try:
    ...
    # transformers>=5 renamed the multimodal auto class. Text-only FiRe-OPD
    # runs use AutoModelForCausalLM, but keeping this alias preserves old verl
    # config paths on newer cluster images.
